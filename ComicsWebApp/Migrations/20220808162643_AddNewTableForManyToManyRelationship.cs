...
{
    public partial class AddNewTableForManyToManyRelationship : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComicsComicsGenres", x => new { x.ComicsId, x.GenresId });
                    table.ForeignKey(
                        name: "FK_ComicsComicsGenres_Comics_ComicsId",
                        column: x => x.ComicsId,
                        principalTable: "Comics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ComicsComicsGenres_ComicsGenres_GenresId",
                        column: x => x.GenresId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ComicsComicsGenres_GenresId",
                table: "ComicsComicsGenres",
                column: "GenresId");
        }
